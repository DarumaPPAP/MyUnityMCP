...
namespace UnityGraphicsMcp
{
	public sealed class UnityGraphicsMcpSaveEvaluationTests
	{
		...
		public void Bridge_DiscoversSaveEvaluationTools_AndKeepsThemDisabledByDefault()
		{
			...
			Assert.That(
				GetToolAttribute(typeof(GraphicsPrepareSavePlanTool)).AutoRegister,
				Is.False);
			Assert.That(
				GetToolAttribute(typeof(GraphicsApplySavePlanTool)).AutoRegister,
				Is.False);
			Assert.That(
				GetToolAttribute(typeof(GraphicsCaptureEvaluationTool)).AutoRegister,
				Is.False);
			Assert.That(
				GetToolAttribute(typeof(GraphicsRefineDirectionTool)).AutoRegister,
				Is.False);
		}
