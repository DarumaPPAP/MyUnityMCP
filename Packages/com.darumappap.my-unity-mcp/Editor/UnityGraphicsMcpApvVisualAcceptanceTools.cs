...
namespace UnityGraphicsMcp
{
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsPrepareApvBakePlanTool
	{
		public sealed class Parameters
		{
			...
			public UnityGraphicsMcpApvBakePlanInput input { get; set; }
		}
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpInspection.PrepareApvBakePlan(
	...
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsStartApvBakeTool
	{
		public sealed class Parameters
		{
			[ToolParameter("Request ID。", Required = false)]
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpInspection.StartApvBake(
					parameters.requestId,
					parameters.planId,
					parameters.expectedRevision,
	...
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsGetApvBakeStatusTool
	{
		public sealed class Parameters
		{
			[ToolParameter("Request ID。", Required = false)]
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpInspection.GetApvBakeStatus(
					parameters.requestId,
					parameters.jobId));
		}
	}
	...
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsCancelApvBakeTool
	{
		public sealed class Parameters
		{
			[ToolParameter("Request ID。", Required = false)]
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpInspection.CancelApvBake(
					parameters.requestId,
					parameters.jobId));
		}
	}
	...
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsPrepareAcceptanceProfileTool
	{
		public sealed class Parameters
		{
			[ToolParameter("Request ID。", Required = false)]
			...
			public UnityGraphicsMcpAcceptanceProfileInput input { get; set; }
		}
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpInspection.PrepareAcceptanceProfile(
					parameters.requestId,
					parameters.expectedRevision,
					parameters.input));
		}
	...
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsEvaluateCaptureTool
	{
		public sealed class Parameters
		{
			[ToolParameter("Request ID。", Required = false)]
			...
			public UnityGraphicsMcpEvaluationMeasurementInput[] measurements { get; set; }

			[ToolParameter("実機またはPlayer計測のPerformance Measurement。", Required = false)]
			public UnityGraphicsMcpPerformanceMeasurementInput performance { get; set; }
		}
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpInspection.EvaluateCapture(
					parameters.requestId,
	...
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsRefineFromEvaluationTool
	{
		public sealed class Parameters
		{
			[ToolParameter("Request ID。", Required = false)]
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpInspection.RefineFromEvaluation(
					parameters.requestId,
