...
namespace UnityGraphicsMcp
{
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsGetExecutionStatusTool
	{
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpExecutionHardening.GetExecutionStatus(
	...
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsCancelExecutionTool
	{
		public sealed class Parameters
		{
			[ToolParameter("Request ID。", Required = false)]
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpExecutionHardening.CancelExecution(
					parameters.requestId,
					parameters.executionId,
					parameters.reason));
		}
	...
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsGetExecutionHistoryTool
	{
		public sealed class Parameters
		{
			[ToolParameter("Request ID。", Required = false)]
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpExecutionHardening.GetExecutionHistory(
					parameters.requestId,
					parameters.tool,
	...
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsGetErrorCatalogTool
	{
		public sealed class Parameters
		{
			[ToolParameter("Request ID。", Required = false)]
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpExecutionHardening.GetErrorCatalog(
					parameters.requestId));
		}
	}
	...
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsGetSupportMatrixTool
	{
		public sealed class Parameters
		{
			[ToolParameter("Request ID。", Required = false)]
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpExecutionHardening.GetSupportMatrix(
					parameters.requestId));
		}
	}
}
