...
namespace UnityGraphicsMcp
{
	...
	public sealed class DirectionPlan
	{
	...
	public static partial class Inspection
	{
		...
		public static ToolResult CompileDirection(
			string requestId,
			string goal,
		...
		public static ToolResult PreviewPlan(
			string requestId,
			string planId,
			long? expectedRevision)
		{
		...
		private static List<PlanRecommendation> BuildDirectionRecommendations(
			Dictionary<string, object> projectContext,
		...
		private static PlanRecommendation CreateRecommendation(
			...
			DirectionPlan plan)
		{
			...
			foreach (PlanRecommendation recommendation in plan.Recommendations)
			{
