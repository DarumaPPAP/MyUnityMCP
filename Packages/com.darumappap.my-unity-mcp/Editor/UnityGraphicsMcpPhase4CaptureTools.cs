...
namespace UnityGraphicsMcp
{
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsCaptureEvidenceTool
	{
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpInspection.CaptureEvidence(
	...
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsSubmitVisualReviewTool
	{
		public sealed class Parameters
		{
			[ToolParameter("Request ID。", Required = false)]
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpInspection.SubmitVisualReview(
					parameters.requestId,
	...
	[McpForUnityTool(
		...
		AutoRegister = false,
		Group = "core")]
	public static class GraphicsRefineFromVisualReviewTool
	{
		public sealed class Parameters
		{
			[ToolParameter("Request ID。", Required = false)]
		...
		public static object HandleCommand(JObject @params)
		{
			return UnityGraphicsMcpToolBridge.Execute<Parameters>(
				@params,
				parameters => UnityGraphicsMcpInspection.RefineFromVisualReview(
					parameters.requestId,
