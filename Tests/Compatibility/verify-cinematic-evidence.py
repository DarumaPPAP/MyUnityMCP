#!/usr/bin/env python3
"""Validate the checked-in Unity 6 URP Cinemachine/Timeline evidence contract."""
...
EVIDENCE = ROOT / "Tests/Compatibility/unity6-urp-cinematic-evidence.yaml"
...
def main() -> int:
    ...
    if data.get("case") != "unity-6-urp-cinematic-timeline":
    ...
    if data.get("support", {}).get("compatibility_backend") != "urp_native_api":
        fail("cinematic evidence must use the URP native adapter")
