...
namespace UnityGraphicsMcp
{
	public sealed class PlanningTests
	{
		...
		{
			ToolResult result = CompileDirection(
				"test-empty-intent",
				null,
				null,
				null,
		...
		public void CompileDirection_StructuredIntentCreatesSixSectionPlan()
		{
			...
			List<PlanRecommendation> recommendations =
				data["recommendations"] as List<PlanRecommendation>;
		...
		public void PreviewPlan_UsesExistingLightAsModifiedForecastWithoutApplyingChanges()
		{
			...
			ToolResult compileResult = CompileDirection(
		...
		private static ToolResult CompileDirection(
			string requestId,
			string goal,
		...
		{
			return Inspection.CompileDirection(
				requestId,
				goal,
				null,
				null,
