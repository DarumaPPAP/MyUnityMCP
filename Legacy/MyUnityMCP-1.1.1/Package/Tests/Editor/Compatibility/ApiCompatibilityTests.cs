	...
	public sealed class UnityApiCompatibilityTests
	{
		...
		public void Resolve_6000_0_UsesBaseWithoutEntityIdRule()
		{
			List<UnityApiCompatibilityRule> rules =
				ApiCompatibility.GetApplicableRules("6000.0.75f1");
		...
		{
			List<UnityApiCompatibilityRule> rules =
				ApiCompatibility.GetApplicableRules("6000.2.0f1");
		...
		public void Resolve_6000_4_ContainsConfirmedEntityIdAndRenderGraphBoundary()
		{
			Dictionary<string, object> summary =
				ApiCompatibility.BuildProjectSummary("6000.4.11f1");
		...
		{
			Dictionary<string, object> summary =
				ApiCompatibility.BuildProjectSummary("6000.5.0f1");
			List<Dictionary<string, object>> rules =
				summary["rules"] as List<Dictionary<string, object>>;
		...
		{
			Dictionary<string, object> summary =
				ApiCompatibility.BuildProjectSummary("6000.6.0a7");
			List<string> buckets = summary["maintenanceBuckets"] as List<string>;
			List<Dictionary<string, object>> rules =
				summary["rules"] as List<Dictionary<string, object>>;
		...
		public void Resolve_6000_4_And_6000_5_TrackConfirmedSceneHandleBoundary()
		{
			Dictionary<string, object> warningSummary =
				ApiCompatibility.BuildProjectSummary("6000.4.12f1");
			...
			Dictionary<string, object> errorSummary =
				ApiCompatibility.BuildProjectSummary("6000.5.5f1");
		...
		{
			Dictionary<string, object> summary =
				ApiCompatibility.BuildProjectSummary("6000.7.0a2");
			List<Dictionary<string, object>> rules =
				summary["rules"] as List<Dictionary<string, object>>;
		...
		{
			Assert.That(ApiCompatibility.ParseUnityVersion("6000.7.0a2").ToString(3), Is.EqualTo("6000.7.0"));
			Assert.That(ApiCompatibility.ParseUnityVersion("6000.4.11f1").ToString(3), Is.EqualTo("6000.4.11"));
		}
